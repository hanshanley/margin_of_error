...
<img src="/artifacts/legacy/echo-chambers-embedded-in-the-structure-of-news-media-websites/figure-01.png" alt={"Pictured here is the distribution of the partisanship of each website in our 950 websites selected (-1 (liberal/Democratic-leaning) to +1 (conservative/Republican-leaning). There was an overall liberal bias, despite my s"} width="661" height="391" loading="lazy" decoding="async" />
...
<img src="/artifacts/legacy/echo-chambers-embedded-in-the-structure-of-news-media-websites/figure-02.png" alt={"Pictured here are the connections amongst different news websites. Each node represents a different website while the directed edges represent whether each website links to another one. The more blue a website, the more "} width="493" height="445" loading="lazy" decoding="async" />
...
<img src="/artifacts/legacy/echo-chambers-embedded-in-the-structure-of-news-media-websites/figure-03.png" alt={"Pictured is the percentage of shared domain connections that news websites have with our conspiracy theory websites as a function of their URLs polarization level. On average, as websites become more polarized they share"} width="623" height="381" loading="lazy" decoding="async" />
